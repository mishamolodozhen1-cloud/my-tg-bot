...
OPENROUTER_API_KEY = "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"  # ваш ключ

# Пробуем использовать openrouter/free вместо конкретной модели
CHAT_MODEL = "openrouter/free"        # авто-выбор лучшей бесплатной модели
...
def chat_with_ai(user_id, user_text):
    ...
    headers = {
        ...
        "HTTP-Referer": "https://t.me/your_bot",         # обязательный заголовок
        "X-OpenRouter-Title": "My Telegram Bot",         # опционально
    }
    payload = {
        "model": CHAT_MODEL,
        "messages": history,
...
def text_to_speech(text):
    ...
    headers = {
        ...
        "X-OpenRouter-Title": "My Telegram Bot",
    }
    payload = {
        "model": TTS_MODEL,
        "input": text,
